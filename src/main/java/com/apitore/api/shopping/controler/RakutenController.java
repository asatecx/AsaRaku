...
//	private RestTemplate restTemplate;
	...
	@RequestMapping(value = "/IchibaItem/Search", method = RequestMethod.POST)
	public ResponseEntity<Map<String, Object>> ichibaItemSearch(
			//      @RequestParam("applicationId")
			//      String applicationId,
			@RequestParam(value = "affiliateId", required = false, defaultValue = "") String affiliateId,
		...
		try {
			...
			params.put("applicationId", RAKUTEN_APPLICATION_ID);
